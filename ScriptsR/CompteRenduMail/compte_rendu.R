...
print("### Lieu (1er chiffre: NA non répondu ou pas concerné)###")
table(postes$lieu)

print("### Lieu doctorat (1er chiffre: NA non répondu ou pas concerné)###")
table(postes$lieuThese)

print("### Salaire France (PAS NETTOYÉ: MIN, MEAN, MAX BIDON) ###")
quantile(postes$salaire[postes$lieu != "Étranger"], na.rm=TRUE)

print("### Salaire Étranger (PAS NETTOYÉ: MIN et MAX BIDON) ###")
quantile(postes$salaire[postes$lieu == "Étranger"], na.rm=TRUE)

print("### Salaire Doctorat France (PAS NETTOYÉ: MIN, MEAN, MAX BIDON) ###")
quantile(postes$salaireThese[postes$lieuThese != "Étranger"], na.rm=TRUE)
