...
r14 = data.frame(region = data2014$LieuTravailDetailEnquete2012, labo= data2014$LieuLaboDoctoratEnquete2012, promo=  data2014$AnneeDiplome)
r13 = data.frame(region = data2013$LieuTravailDetailEnquete2012, labo= data2013$LieuLaboDoctoratEnquete2012, promo=  data2013$AnneeDiplome)
r12 = data.frame(region = data2012$LieuTravailDetailEnquete2012, labo= data2012$LieuLaboDoctoratEnquete2012, promo=  data2012$AnneeDiplome)
