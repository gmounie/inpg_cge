...
## CGE: juste Industrie
                                        # France sans prime
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2016 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2016 & salaireBrut2017$LieuTravailDetailEnquete2012 != "Abroad"])

summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2015 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2015 & salaireBrut2017$LieuTravailDetailEnquete2012 != "Abroad"])

summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2014 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2014 & salaireBrut2017$LieuTravailDetailEnquete2012 != "Abroad"])

summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2016 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Homme"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2016 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Femme"])

summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2015 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Homme"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2015 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Femme"])

summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2014 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Homme"])
summary(salaireBrut2017$SalaireBrutAnnuelAvecPrimes[salaireBrut2017$AnneeDiplome== 2014 & salaireBrut2017$LieuTravailDetailEnquete2012 == "Abroad" & salaireBrut2017$Sexe == "Femme"])
...
summary(salaire$SalaireAvecPrime[salaire$AnneeEnquete == 2017 & salaire$AnneeDiplome== 2015 & salaire$Sexe == "Femme"])
summary(salaire$SalaireAvecPrime[salaire$AnneeEnquete == 2017 & salaire$AnneeDiplome== 2015 & salaire$Sexe == "Homme"])
summary(salaire$SalaireAvecPrime[salaire$AnneeEnquete == 2017 & salaire$AnneeDiplome== 2014 & salaire$Sexe == "Femme"])
summary(salaire$SalaireAvecPrime[salaire$AnneeEnquete == 2017 & salaire$AnneeDiplome== 2014 & salaire$Sexe == "Homme"])
...
s17f = na.omit(s17[s17$SalaireAvecPrime < 100000 & s17$lieu != "Abroad" & s17$activite != "Studying for a PhD" & s17$SalaireAvecPrime != 0,])
p = ggplot(data=s17f, aes(x=AnneeDiplome, y=SalaireAvecPrime, ymin=0)) + geom_jitter(position = position_jitter(width=0.3), aes(alpha=0.01)) + geom_boxplot(outlier.size=0.1)
p + theme(title=element_text("Salaire Brut (+ primes) France, hors thèse, par année de promotion et année de l'enquête")) + geom_text(label="2 2015 > 100kE", x= 2, y = 85000 , color = "red", size= 8) + ggtitle("Salaire France, hors thèse, avec prime, enquête 2017")
