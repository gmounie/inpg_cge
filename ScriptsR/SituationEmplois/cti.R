...
## salaire median Thésard
## France hors prime
data2018 %>% select(X14..AnneeDiplomeVerifieParLeDiplome, X20..ActiviteActuelle, X33..EmploiLieuRegionEtranger, X100..VolontariatRegionEtranger, X122..TheseRegionEtranger, X131..TheseSalaireBrutAnnuelHorsPrimes, X136..TheseSalaireBrutAnnuelAvecPrimes) %>%  filter(X20..ActiviteActuelle == "En thèse") %>% group_by(X14..AnneeDiplomeVerifieParLeDiplome) %>% summarize(salaire = median(X131..TheseSalaireBrutAnnuelHorsPrimes, na.rm=TRUE),nb=n())

## France Avec prime HF
data2018 %>% select(X14..AnneeDiplomeVerifieParLeDiplome, X20..ActiviteActuelle, X33..EmploiLieuRegionEtranger, X100..VolontariatRegionEtranger, X122..TheseRegionEtranger, X131..TheseSalaireBrutAnnuelHorsPrimes, X136..TheseSalaireBrutAnnuelAvecPrimes) %>%  filter(X20..ActiviteActuelle == "En thèse") %>% group_by(X14..AnneeDiplomeVerifieParLeDiplome) %>% summarize(salaire = median(X136..TheseSalaireBrutAnnuelAvecPrimes, na.rm=TRUE), nb=n())
