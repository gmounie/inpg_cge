...
p + scale_fill_manual(values=c("blue","green","SlateBlue4","chartreuse4","red","yellow", "orange")) + opts(title="Situation des diplômés début 2O13, 6 et 18 mois") + xlab("Promo Ensimag") + ylab("Pourcentage")
dev.off()   
