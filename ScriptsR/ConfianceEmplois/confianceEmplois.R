...
cf6 = data.frame(year = as.integer(c(2013,2012,2011,2010)),
  pmoyen = c(cf6_2013$pmoyen, cf6_2012$pmoyen, cf6_2011$pmoyen, cf6_2010$pmoyen),
  pmin = c(cf6_2013$pmin, cf6_2012$pmin, cf6_2011$pmin, cf6_2010$pmin),
  pmax = c(cf6_2013$pmax, cf6_2012$pmax, cf6_2011$pmax, cf6_2010$pmax))

cf18 = data.frame(year = as.integer(c(2012,2011,2010, 2009)),
  pmoyen = c(cf18_2012$pmoyen, cf18_2011$pmoyen, cf18_2010$pmoyen, cf18_2009$pmoyen),
  pmin = c(cf18_2012$pmin, cf18_2011$pmin, cf18_2010$pmin, cf18_2009$pmin),
  pmax = c(cf18_2012$pmax, cf18_2011$pmax, cf18_2010$pmax, cf18_2009$pmax))
